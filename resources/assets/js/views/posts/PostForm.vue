        ...
        <form @submit.prevent="onSubmit" @keydown="form.errors.clear()">
            ...
            <div :class="isModal ? '' : 'card-body'">
                ...
                <div class="form-group">
                    ...
                    <span class="alert alert-danger" v-if="form.errors.has('title')"  v-text="form.errors.get('title')"></span>
                    {{setData}}
                </div>
                <div class="form-group">
                    ...
                    <span class="alert alert-danger" v-if="form.errors.has('body')"  v-text="form.errors.get('body')"></span>
                    {{setData}}
                </div>
